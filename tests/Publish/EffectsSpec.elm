...
model =
    let
        initialModel =
            Tuple.first <| RootModel.initialModel "/" (Just "user") Nothing
    in
...
tests =
    signalDescribe "Publish.Effects"
        [ signalDescribe "Head Publish"
        ...
        , signalDescribe "FollowBlock Publish"
